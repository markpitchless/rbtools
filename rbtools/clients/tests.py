...
class BazaarClientTests(SCMClientTests):
    ...
    def test_diff_grand_parent(self):
        ...
        # parent:
        self.client.options.parent_branch = self.original_branch
    ...
    def test_guessed_summary_and_description_in_diff(self):
        ...
        self.client.options.guess_summary = True
        self.client.options.guess_description = True
        self.client.diff(None)
        
        self.assertEquals("commit 3", self.client.options.summary)
        
        description = self.client.options.description
